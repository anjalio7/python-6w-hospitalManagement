...
class Add_doctor:
    ...
    def addDoctorFrame(self):
        ...
        self.name.place(x=570,y=200,width=210,height=30)
        ...
        self.special.place(x = 570,y=250,width="210",height="30")
        ...
        self.qual.place(x = 570,y=350,width="210",height="30")
        
        self.charges=StringVar()
        self.charges=Entry(self.first,textvariable=self.charges)
        self.charges.place(x=570,y=400,width=210,height=30)
    ...
    def addDoctor(self):
        ...
        if self.username.get() == "":
            messagebox.showinfo('Alert','Please enter doctor username')
        elif self.password.get() == "":
            messagebox.showinfo('Alert','Please enter doctor password')
        elif self.name.get() == '':
